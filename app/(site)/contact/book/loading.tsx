export default function BookCallLoading() {
  return (
    <section className="flex flex-1 flex-col px-6 py-24 text-white">
      <div className="mx-auto w-full max-w-2xl animate-pulse">
        <div className="mb-8 h-4 w-16 bg-white/10" />
        <div className="mb-3 h-3 w-24 bg-white/10" />
        <div className="mb-10 h-8 w-72 bg-white/10" />
